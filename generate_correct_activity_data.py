#!/usr/bin/env python3
"""
Script to generate realistic system activity data using correct account numbers
"""
...
def generate_correct_activities():
    """Generate realistic activity data using correct account numbers"""
    ...
    with app.app_context():
        ...
        # Correct account numbers from the database
        correct_account_numbers = ['12345678', '87654321']
        print(f"Using account numbers: {correct_account_numbers}")
        ...
        for i in range(50):
            try:
                ...
                account_number = random.choice(correct_account_numbers)
                ...
                print(f"Added activity {i+1}: {activity_type} for account {account_number}")
